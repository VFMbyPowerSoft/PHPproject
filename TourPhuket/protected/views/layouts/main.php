...
<div class="container" id="page">
	...
	<div id="mainmenu">
		...
		/*$this->widget('zii.widgets.CMenu',array(
			...
			$CustomerType=Yii::app()->session['cus_type'];
			if($CustomerType==''){
				//Guest
				$this->widget('zii.widgets.CMenu',array(
					'items'=>array(
				...
				$this->widget('zii.widgets.CMenu',array(
					'items'=>array(
						...
						array('label'=>'booking Management', 'url'=>array('/booking/admin')),
						array('label'=>'promotion Management', 'url'=>array('/promotion/admin')),
						array('label'=>'tour Management', 'url'=>array('/tour/admin')),
						array('label'=>'Login', 'url'=>array('/site/login'), 'visible'=>Yii::app()->user->isGuest),
						array('label'=>'Logout ('.Yii::app()->user->name.')', 'url'=>array('/site/logout'), 'visible'=>!Yii::app()->user->isGuest)
					),
				));
